"""Run Sprint 4.9 robotics hybrid-QML PPO experiments."""
...
def parse_arguments() -> argparse.Namespace:
    """Parse one frozen principal robotics seed."""
    parser = argparse.ArgumentParser(
        description=("Run one frozen Sprint 4.9 " "robotics hybrid-QML PPO seed.")
    )
    ...
    parser.add_argument(
        ...
        help=("Frozen principal seed. " "Allowed values: 42, 123, 456."),
    )
...
def main() -> None:
    """Run one explicitly selected principal robotics QML seed."""
    ...
    output_path = OUTPUT_DIRECTORY / f"robotics-seed-{seed}.json"
