"""Run Sprint 4.8 autonomous-driving hybrid QML PPO experiments."""
...
def parse_arguments() -> argparse.Namespace:
    """Parse the requested frozen Sprint 4.8 training seed."""
    parser = argparse.ArgumentParser(
        description=(
            "Run one frozen Sprint 4.8 " "autonomous-driving hybrid QML PPO seed."
        )
    )
    ...
    parser.add_argument(
        ...
        help=("Frozen principal training seed. " "Allowed values: 42, 123, 456."),
    )
...
def run_seed(
    *,
    ...
    """Run one frozen autonomous-driving QML seed."""
    ...
    path = OUTPUT_DIRECTORY / f"autonomous_driving-seed-{seed}.json"
...
def main() -> None:
    """Run one explicitly selected frozen QML seed."""
    arguments = parse_arguments()

    run_seed(seed=arguments.seed)
