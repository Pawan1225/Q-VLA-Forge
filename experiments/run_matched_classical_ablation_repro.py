"""Reproduce Sprint 4.12 matched-classical seed-42 runs."""
...
def result_path(
    *,
    ...
    """Return the seed-42 reproduction artifact path."""
...
def serialize_training_result(
    ...
    """Convert one reproduction run to evidence."""
    ...
    return {
        "sprint": "4.12",
        "experiment": ("matched_classical_parameter_ablation_reproduction"),
...
def run_reproduction(
    *,
    ...
    """Run one deterministic seed-42 reproduction."""
    ...
    print()
    print("=" * 62)
    print(f"SPRINT 4.12 MATCHED REPRO — {domain} — seed 42")
    print("=" * 62)
    ...
    output_path = result_path(domain=domain)
...
def parse_args() -> argparse.Namespace:
    """Parse reproduction CLI arguments."""
...
def main() -> None:
    ...
    run_reproduction(domain=args.domain)
